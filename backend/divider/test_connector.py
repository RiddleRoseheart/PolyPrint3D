...
from octoprint_connector import connect_octoprint, disconnect_octoprint, get_connection, is_octoprint_server, is_octoprint_connected

class TestOctoPrintConnector(unittest.TestCase):

    @patch('octoprint_connector.requests.post')
    @patch('octoprint_connector.is_octoprint_server', return_value=True)
    ...
    @patch('octoprint_connector.requests.get')
    @patch('octoprint_connector.is_octoprint_server', return_value=True)
    ...
    @patch('octoprint_connector.get_connection')
